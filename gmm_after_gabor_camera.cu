...
static void help()
{
 printf("\nDo background segmentation, using cvUpdateBGStatModel().\n"
"Learns the background at the start and then segments using gabor feature extraction.\n"
